...
class WebSocketService {
    ...
    getWsUrl() {
        ...
        const apiUrl = (typeof getApiBaseUrl === 'function') ? getApiBaseUrl() : ((typeof import.meta !== 'undefined' && import.meta.env?.VITE_API_URL) ? import.meta.env.VITE_API_URL.replace(/\/+$/, '') : '');
        if (apiUrl) {
