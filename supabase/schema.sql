-- ====================================================================
-- Battle Buddy - Minimum Database Schema (Supabase / PostgreSQL)
-- Minimum 5 Tables: sessions, transcripts, triage_events, events, recordings
...
-- Backend server-side access is granted via service_role key
